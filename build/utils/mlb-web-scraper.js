...
export class MLBWebScraper {
    ...
    // =============================================================================
    async scrapeMLBComPlayer(playerName, season) {
    ...
    async scrapeBaseballReference(playerName, season) {
    ...
    async scrapeFanGraphs(playerName, season) {
    ...
    async searchMLBCom(query) {
        // Implementation for MLB.com search
        return [];
    }
    async searchBaseballReference(query) {
    ...
    parseInning(inningText) {
        const match = inningText.match(/(\d+)/);
        return match ? parseInt(match[1]) : undefined;
    }
    parseInjuryStatus(headline) {
    ...
    extractPlayerUrlFromBRef(html, playerName) {
...
//# sourceMappingURL=mlb-web-scraper.js.map